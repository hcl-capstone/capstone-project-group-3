...
CREATE TABLE `order` (
  ...
  KEY `FK_order_address_idx` (`delivery_address`),
  KEY `FK_order_user_idx` (`user_id`),
  CONSTRAINT `FK_order_address` FOREIGN KEY (`delivery_address`) REFERENCES `address` (`address_id`),
...
CREATE TABLE `shopping_cart` (
  ...
  PRIMARY KEY (`order_id`,`product_id`,`session_id`),
  KEY `FK_cart_session_idx` (`session_id`),
  KEY `FK_cart_product_idx` (`product_id`),
  CONSTRAINT `FK_cart_order` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`),
  CONSTRAINT `FK_cart_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`),
  CONSTRAINT `FK_cart_session` FOREIGN KEY (`session_id`) REFERENCES `session` (`session_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_address_junction`
--

DROP TABLE IF EXISTS `user_address_junction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_address_junction` (
  `user_id` int NOT NULL,
...
-- Dump completed on 2022-08-05 12:13:36
